...
public class Lab21_Vars {
	...
	public static void main(String[] args) {
		...
		int total = 0;   //created total outside of the loop
		//for (int i = 0; i < 10; i++) {
		for (i = 0; i < 10; i++) {  // i is already initialized
			//int total = 0;
			total += i;
		}
		total = total * total;
		...
		//jack = monterey;
		Cheese jack = new Cheese(); //We should create different object jack, because if otherwise, we use the same one
		...
		int num1 = input.nextInt(); //added variable
		//if (num1 > var3) {
			System.out.print("Enter second number: ");
			int num2 = input.nextInt();
			if (num1 > var3) //this if statement manages to replace the rest of unnecessary code
